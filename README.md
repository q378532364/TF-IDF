...
不基于向量数据库，基于sk-learn 词频算法，完成简易的RAG问答系统,可以用于学习余弦相似法
...
## 截图
仅会基于文档的原文回答，不会基于其他来源的资料。

![img](./example/ebd73770-499f-47d5-9dc3-88b9ba3ada6a.png)

![img](./example/微信图片_2026-06-08_155744_624.png)
